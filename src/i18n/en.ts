export const en = {
  ...
  ways: {
    ...
    rent: { title: "Rent", desc: "Turn your idle tools or gear into extra income." },
    give: { title: "Give Away", desc: "Declutter with a conscience and help a neighbor." },
    borrow: { title: "Borrow", desc: "Save money and space by sourcing items temporarily." },
    search: { title: "Search", desc: "Find local services—from dog walking to web design—provided by real people." },
  },
  trust: {
    title: "Built on Trust, Not Algorithms",
    desc: "We believe the local economy should be powered by humans, not bots or data-miners.",
    verified: { title: "Verified Humans", desc: "Secure SSO-logins (Google, GitHub, Apple, etc.) ensure everyone is who they say they are." },
    data: { title: "Data Sovereignty", desc: "Your data is stored on the platform, not sold to third-party advertisers." },
    regional: { title: "Regional Focus", desc: "Algorithms don't decide what you see; your physical proximity does." },
  },
  fediverse: {
    title: "The Power of the Fediverse",
    desc: "Sharecycle isn't another \"walled garden\" app. We play well with others.",
    activitypub: { title: "ActivityPub Integration", desc: "As part of the Fediverse, your local instance can talk to others. Follow listings and interact across the decentralized web." },
    caldav: { title: "CalDAV Booking", desc: "Sync rentals and service appointments directly to your favorite calendar (Apple, Google, Outlook, or Proton)." },
    chat: { title: "Chat Where You Are", desc: "Get instant notifications and manage inquiries through our bot-integrations for Telegram, Discord, Slack, or Matrix." },
  },
  support: {
  ...
  quote: "\"Sharecycle isn't just an app; it's a handshake in digital form. It's about knowing your neighbor and keeping resources within the community loop.\"",
  cta: {
